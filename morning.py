...
'''
user_id_list = [
    {'user_id': user_id_1, "name": '张三', "date": "2021-04-02", "birthday": "07-25",
     'city': '440306'}
    ,{'user_id': user_id_2, "name": 'Orange', "date": "2021-04-02", "birthday": "08-07",
      'city': '440306'}
]
...
def wx_push():
    for user in user_id_list:
        ...
        data = {
            ...
            "min": {"value": today.strftime("%H:%M"), "color": get_random_color()}
        }
